...
/* themes/solo/templates/navigation/pager.html.twig */
class __TwigTemplate_1fbbf2c0d3b6ceeeb5af0d636b43197b extends Template
{
    private $source;
    private $macros = [];
    ...
    <ul class=\"solo-clear pager__items js-pager__items\">
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["items"] ?? null), "first", [], "any", false, false, true, 38)) {
                // line 39
                echo "        <li class=\"solo-button pager__item pager__item--first\">
          <a href=\"";
                // line 40
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["items"] ?? null), "previous", [], "any", false, false, true, 47)) {
                // line 48
                echo "        <li class=\"solo-button pager__item pager__item--previous\">
          <a href=\"";
                // line 49
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["ellipses"] ?? null), "previous", [], "any", false, false, true, 56)) {
                // line 57
                echo "        <li class=\"solo-button pager__item pager__item--ellipsis\" role=\"presentation\">&hellip;</li>
      ";
            }
            // line 59
            echo "      ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["item"]) {
                // line 61
                echo "        <li class=\"solo-button pager__item";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar((((($context["current"] ?? null) == $context["key"])) ? (" solo-active-pager is-active") : ("")));
                echo "\">
          ";
                // line 62
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 80)) {
                // line 81
                echo "        <li class=\"solo-button pager__item pager__item--next\">
          <a href=\"";
                // line 82
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["items"] ?? null), "last", [], "any", false, false, true, 89)) {
                // line 90
                echo "        <li class=\"solo-button pager__item pager__item--last\">
          <a href=\"";
                // line 91
...
";
    ...
    {
        return "themes/solo/templates/navigation/pager.html.twig";
    }
    ...
    {
        return new Source("", "themes/solo/templates/navigation/pager.html.twig", "C:\\xampp\\htdocs\\projet1\\themes\\solo\\templates\\navigation\\pager.html.twig");
    }
