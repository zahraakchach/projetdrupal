...
function showcase_lite_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['mtt_settings']['looknfeel_tab']['looknfeel']['premium_description'] = array(
   ...
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-01-looknfeel.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['regions_tab']['regions']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-02-region.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['post_tab']['post']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-03-article.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['layout_tab']['layout_modes']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-04-layout.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['font_tab']['font']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-05-fonts.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['slideshows_tab']['slideshow']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-06-slideshow.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['video_bg_tab']['video_bg']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-07-videobackground.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['isotope_tab']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-08-isotope.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['google_maps_tab']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium-09-googlemaps.jpg" />
   </a></div> ',
  );
  ...
  $form['mtt_settings']['premium_tab']['premium_description'] = array(
   ...
   <div class="theme-settings-image-wrapper">
   <a href="http://morethanthemes.com/themes/showcaseplus?utm_source=showcase-lite-demo&utm_medium=theme-settings&utm_campaign=free-themes" target="_blank">
   <img src="' . base_path() . \Drupal::service('extension.path.resolver')->getPath('theme', 'showcase_lite') . '/images/premium.jpg" />
   </a></div> ',
  );
